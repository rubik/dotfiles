...
hi LineNr term=bold ctermfg=darkred ctermbg=white guibg=#7f7f7f gui=bold guifg=White
...
hi Comment term=underline ctermfg=darkgrey guifg=#565656
hi pythonComment term=underline ctermfg=darkgrey guifg=#565656
hi Constant term=underline ctermfg=darkyellow guifg=#3fffa7
hi pythonDecorator term=underline ctermfg=darkgreen guifg=#bfbfbf
...
hi Todo term=bold ctermfg=white ctermbg=darkblue guifg=Yellow guibg=Blue
...
"+++ Cream: bookmarks
highlight Cream_ShowMarksHL ctermfg=darkred ctermbg=lightblue cterm=bold guifg=Black guibg=#aacc77 gui=bold
"+++
